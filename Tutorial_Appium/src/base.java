...
public class base {
	...
	/*
	    ...
	    "Desired capability"for our device. "Deniz_device"
		so we can send that file through our driver which we created as a AndroidDriver 
		an we pass url of our server which sends to code to device and var "cap"
		which has got t7he capabilites of our device it like sending Header to API 
		2.driver will send this apk file to our device 
	 */
